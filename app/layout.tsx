...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://animengentot.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "name": `${SITENAME}`,
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "logo": "https://animengentot.pages.dev/favicon.ico",
        "url": "https://animengentot.pages.dev",
        "founder":{
            "@type":"Person",
            "name":"admin",
            "url":"https://animengentot.pages.dev"
        ...
        "url": "https://animengentot.pages.dev",
        "description": `${SITENAME} Video Bokep Indo Jepang Jav Barat Simontok Viral Terbaru Bocil Ngentot Jilbab Smp Mama Sma korea china tante live paksa ngentot abg cewek pijat.`,
        "image": "https://animengentot.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://animengentot.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://animengentot.pages.dev/?q={search_term}", 
